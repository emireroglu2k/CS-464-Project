"""
predict.py - Model 3: Face-Cropped Dataset
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Predict cat breed from image using Model 3")
...
def main() -> int:
    ...
    print("=" * 80)
    print(f"MODEL 3 PREDICTION (Face-Cropped): {args.model}")
    print("=" * 80)
