"""
train_all_augmentations.py - Model 3
...
def main():
    print("=" * 100)
    print("MODEL 3: TRAINING WITH AUGMENTATION COMPARISON (Face-Cropped)")
    print("=" * 100)
    ...
    lines = []
    lines.append("=" * 120)
    lines.append(f"AUGMENTATION STRATEGY COMPARISON - MODEL 3 (Face-Cropped) | {datetime.utcnow().isoformat()}Z")
    lines.append("=" * 120)
    lines.append("")
