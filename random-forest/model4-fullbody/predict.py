"""
predict.py - Model 4: Full Body Images (No Face Cropping)
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Predict cat breed from image using Model 4")
...
def main() -> int:
    ...
    print("=" * 80)
    print(f"MODEL 4 PREDICTION (Full Body): {args.model}")
    print("=" * 80)
